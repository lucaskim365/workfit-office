...
export const USER_SEED: Omit<User, 'sealUrl' | 'photoUrl' | 'signUrl' | 'signType' | 'resignedAt' | 'fcmToken'>[] = [
  ...
  { id: 'U002', empNo: '100002', name: '류지광', dept: '대표이사 직속', position: '이사', jobTitle: '', roleGroup: 'ADMIN', email: 'jgryu@workfit.kr', status: '미사용', lastLogin: '2026-07-07 08:31', managerId: 'U001', password: DEMO_PW },
  // AX지능화본부 — 직책 본부장 / 직급 상무이사
  { id: 'U003', empNo: '200001', name: '손승원', dept: 'AX지능화본부', position: '상무이사', jobTitle: '본부장', roleGroup: 'ADMIN', email: 'smartfactory@workfit.kr', status: '사용', lastLogin: '2026-07-07 09:02', managerId: 'U001', password: DEMO_PW },
  // 품질심사팀 — 팀장 강윤석(직급 이사)
  { id: 'U006', empNo: '300001', name: '강윤석', dept: '품질심사팀', position: '이사', jobTitle: '팀장', roleGroup: 'USER', email: 'yskang@workfit.kr', status: '사용', lastLogin: '2026-07-07 08:12', managerId: 'U003', password: DEMO_PW },
  { id: 'U007', empNo: '300002', name: '최지혜', dept: '품질심사팀', position: '사원', jobTitle: '팀원', roleGroup: 'USER', email: 'jhchoi@workfit.kr', status: '사용', lastLogin: '2026-07-06 17:55', managerId: 'U006', password: DEMO_PW },
  // AX 솔루션컨설팅팀 — 팀장 홍형표(직급 부장)
  { id: 'U008', empNo: '400001', name: '홍형표', dept: 'AX 솔루션컨설팅팀', position: '부장', jobTitle: '팀장', roleGroup: 'OPERATOR', email: 'hphong@workfit.kr', status: '사용', lastLogin: '2026-07-07 07:48', managerId: 'U003', password: DEMO_PW },
  // AX PMO팀 — 팀장 박명규(부장) / 부팀장 박광래(차장)
  { id: 'U009', empNo: '500001', name: '박명규', dept: 'AX PMO팀', position: '부장', jobTitle: '팀장', roleGroup: 'OPERATOR', email: 'mgpark@workfit.kr', status: '사용', lastLogin: '2026-07-07 08:05', managerId: 'U003', password: DEMO_PW },
