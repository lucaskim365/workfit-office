...
export const APPROVAL_ROUTE_SEED: ApprovalRouteRule[] = [
  ...
  },
  {
    ...
    steps: [s('DRAFTER', '결재'), s('ROLE_CEO', '참조')],
  },
  ...
  // --- 외근 신청서 ---
  {
    ...
    steps: [s('DRAFTER', '결재'), s('DEPT_HEAD', '참조')],
  },
  {
    id: 'RR-OUTSIDE-LEADER', name: '외근·팀장 기안: 본부장 참조', priority: 5, active: true,
    ...
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '참조', 1)],
  },

  // --- 연장근로 신청서 ---
  {
    id: 'RR-OVERTIME-ALL', name: '연장근로·공통: 담당결재➔팀장 거쳐 본부장 전결 (대표 참조)', priority: 6, active: true,
    docType: '연장근로', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: null, amountTo: null,
  ...
  // --- 국내 출장 ---
  {
    ...
    steps: [s('DRAFTER', '결재'), s('ROLE_CEO', '전결')],
  },
  {
    id: 'RR-DOMESTIC-TRIP-M', name: '국내출장·중액(100만~300만 미만): 팀장 기안➔본부장 전결', priority: 11, active: true,
    docType: '국내출장', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: 100 * 만, amountTo: 300 * 만,
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '전결', 1)],
  },
  {
    id: 'RR-DOMESTIC-TRIP-S', name: '국내출장·소액(100만 미만): 담당결재➔팀장➔본부장 전결', priority: 12, active: true,
    docType: '국내출장', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: 0, amountTo: 100 * 만,
  ...
  // --- 지출결의서 통합 전결 규칙 (전결 규정 별지 반영) ---
  {
    ...
    deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '참조', 1)],
  },
  {
    ...
    deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('DEPT_HEAD', '전결')],
  },
  {
  ...
  // --- 인장 날인 요청서 ---
  {
    ...
    docType: '인장날인', conditionKey: 'sealType', conditionValues: ['법인인감'], deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '결재', 1), s('ROLE_CEO', '전결')],
  },
  {
    id: 'RR-SEAL-NORMAL', name: '인장날인·증명서/사용인감직인: 팀장 기안➔본부장 전결', priority: 28, active: true,
    docType: '인장날인', conditionKey: 'sealType', conditionValues: ['법인인감증명서', '사용인감 및 직인'], deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '전결', 1)],
  },
  ...
  // --- 공문 발송 신청서 ---
  {
    ...
    docType: '공문발송', conditionKey: 'docCategory', conditionValues: ['일반공문'], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('DEPT_HEAD', '결재'), s('PARENT_DEPT_HEAD', '전결', 1)],
  },
  {
    id: 'RR-PUBLISH-LEGAL', name: '공문발송·법률문서: 담당결재➔팀장➔본부장➔대표이사 전결', priority: 30, active: true,
    docType: '공문발송', conditionKey: 'docCategory', conditionValues: ['법률문서'], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: null, amountTo: null,
  ...
  // --- 접대비 품의서 ---
  {
    ...
    docType: '접대비', conditionKey: 'budgetStatus', conditionValues: ['접대비 예산 한도 내'], deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '참조', 1)],
  },
  {
  ...
  // --- 일반 품의서 (자산 / 비품 / 일반경비) ---
  {
    ...
    docType: '품의', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: 500 * 만, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('DEPT_HEAD', '결재'), s('PARENT_DEPT_HEAD', '결재', 1), s('ROLE_CEO', '전결')],
  },
  {
    id: 'RR-PURCHASE-M', name: '품의·중액(10만 이상 500만 미만): 담당결재➔팀장➔본부장 전결 (대표이사 참조)', priority: 31, active: true,
    docType: '품의', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: 10 * 만, amountTo: 500 * 만,
    steps: [s('DRAFTER', '결재'), s('DEPT_HEAD', '결재'), s('PARENT_DEPT_HEAD', '전결', 1), s('ROLE_CEO', '참조')],
  },
  {
  ...
  // --- 원자재 품의서 ---
  {
    ...
    docType: '원자재품의', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: 1000 * 만, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('DEPT_HEAD', '결재'), s('PARENT_DEPT_HEAD', '결재', 1), s('ROLE_CEO', '전결')],
  },
  {
    id: 'RR-MATERIAL-S', name: '원자재품의·소액(1000만 미만): 담당결재➔팀장➔본부장 전결 (대표이사 참조)', priority: 34, active: true,
    docType: '원자재품의', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 5, positionToRank: 9, amountFrom: 0, amountTo: 1000 * 만,
    steps: [s('DRAFTER', '결재'), s('DEPT_HEAD', '결재'), s('PARENT_DEPT_HEAD', '전결', 1), s('ROLE_CEO', '참조')],
  },
  ...
  // --- 소모품 신청서 ---
  {
    ...
    docType: '소모품신청', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: 10 * 만, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '전결', 1)],
  },
  {
    id: 'RR-OFFICE-SUPPLY-S', name: '소모품신청·소액(10만 미만): 담당 기안➔자가전결', priority: 37, active: true,
  ...
  // --- 경조 지원 신청서 ---
  {
    ...
    docType: '경조지원', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '결재'), s('PARENT_DEPT_HEAD', '전결', 1), s('ROLE_CEO', '참조')],
  },
  ...
  // ==========================================
  {
    id: 'RR-GENERAL-DRAFT', name: '기안서·공통: 팀장 기안➔전결', priority: 90, active: true,
    docType: '기안', conditionKey: null, conditionValues: [], deptScope: scAll, positionFromRank: 3, positionToRank: 4, amountFrom: null, amountTo: null,
    steps: [s('DRAFTER', '전결')],
  },
  {
