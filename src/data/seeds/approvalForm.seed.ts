...
export const APPROVAL_FORM_SEED: ApprovalForm[] = [
  ...
  // ── [총무] 기본 및 커스텀 ──
  {
    ...
    closing: '위와 같이 출장을 신청하오니 재가하여 주시기 바랍니다.', active: true, order: 5, system: false, folderId: 'fld-ga',
    fields: [
  ...
  },
  {
    ...
    closing: '위와 같이 지출을 청구하오니 재가하여 주시기 바랍니다.', active: true, order: 6, system: false, folderId: 'fld-ga',
    fields: [
  ...
  {
    id: '비용청구', code: '비용청구', name: '비용 청구서', icon: '🧾', docTitle: '비 용 청 구 서',
    closing: '위와 같이 비용을 청구하오니 재가하여 주시기 바랍니다.', active: true, order: 7, system: false, folderId: 'fld-ga',
    fields: [
      f({ key: 'expenseType', label: '비용 구분', type: '선택', required: true, width: 'half', options: ['간식대', '외근식대', '야근식대', '회식비', '회의비', '교통비(택시)', '교통비(대중교통)', '주유비'] }),
      ...
      f({ key: 'body', label: '사용 내역 및 상세 사유', type: '장문', required: true }),
    ],
  },
  {
    id: '보험신청', code: '보험신청', name: '보험 관련 신청서', icon: '🛡️', docTitle: '보 험 관 련 신 청 서',
    closing: '위와 같이 보험 신청을 하오니 재가하여 주시기 바랍니다.', active: true, order: 8, system: false, folderId: 'fld-ga',
    fields: [
      f({ key: 'insuranceType', label: '보험 종류', type: '선택', required: true, width: 'half', options: ['단체상해보험 가입자 변경', '단체상해보험 재가입', '화재보험', '자동차보험'] }),
      f({ key: 'targetObject', label: '대상(자)/물건', type: '텍스트', required: true, width: 'half', placeholder: '예: 홍길동 / 법인차량 12가3456' }),
      f({ key: 'body', label: '세부 변동 사항 및 신청 내용', type: '장문', required: true }),
    ],
  },
  {
    id: '운반비청구', code: '운반비청구', name: '운반비 청구서', icon: '📦', docTitle: '운 반 비 청 구 서',
    closing: '위와 같이 운반비를 청구하오니 재가하여 주시기 바랍니다.', active: true, order: 9, system: false, folderId: 'fld-ga',
    fields: [
      f({ key: 'deliveryType', label: '배송 방식', type: '선택', required: true, width: 'half', options: ['우편 / 택배', '퀵서비스'] }),
      f({ key: 'amount', label: '운임 비용', type: '금액', required: true, isAmountKey: true, width: 'half' }),
      f({ key: 'body', label: '발송 물품 명세 및 목적지', type: '장문', required: true }),
    ],
  },
  {
    id: '인장날인', code: '인장날인', name: '인장 날인 요청서', icon: 'ตรา', docTitle: '인 장 날 인 요 청 서',
    closing: '위와 같이 인장 날인을 요청하오니 재가하여 주시기 바랍니다.', active: true, order: 10, system: false, folderId: 'fld-ga',
    fields: [
      f({ key: 'sealType', label: '인장 구분', type: '선택', required: true, width: 'half', options: ['법인인감', '법인인감증명서', '사용인감/직인'] }),
      ...
      f({ key: 'body', label: '날인 목적 및 문서 사유', type: '장문', required: true }),
    ],
  },
  {
    id: '공문발송', code: '공문발송', name: '공문 발송 신청서', icon: '✉️', docTitle: '공 문 발 송 신 청 서',
    closing: '위와 같이 공문 발송을 신청하오니 재가하여 주시기 바랍니다.', active: true, order: 11, system: false, folderId: 'fld-ga',
    fields: [
  ...
  {
    id: '접대비품의', code: '접대비품의', name: '접대비 품의서', icon: '🤝', docTitle: '접 대 비 품 의 서',
    closing: '위와 같이 접대비를 품의하오니 재가하여 주시기 바랍니다.', active: true, order: 12, system: false, folderId: 'fld-ga',
    fields: [
      f({ key: 'budgetStatus', label: '예산 한도', type: '선택', required: true, width: 'half', options: ['예산 한도 내', '예산 한도 초과'] }),
