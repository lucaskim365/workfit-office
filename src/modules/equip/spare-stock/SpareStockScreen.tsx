...
import { useSpareStocks } from '@/features/spareStock/useSpareStocks';
...
export default function SpareStockScreen() {
  ...
  if (spares.length === 0) {
    return <div className="grid place-items-center py-20 text-[13px] text-ink3">{isLoading ? '불러오는 중…' : '예비품 재고가 없습니다.'}</div>;
  }
